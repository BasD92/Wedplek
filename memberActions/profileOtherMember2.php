...
if (isset($_POST['clickUsername2'])) {
    $_SESSION['opponentMemberID'] = $_POST['opponentMemberID'];
}

$opponentMemberID = $_SESSION['opponentMemberID'];
    ...
    <section>
        ...
        <?php if (isset($_SESSION['username'])) {
            ...
            <ul class="small-image-list">
                ...
                <?php
                $result = mysqli_query($con, "SELECT * FROM member WHERE id_member = $opponentMemberID");
                ?>
...
?>
    ...
    <?php if (isset($_SESSION['username'])) {
        ...
        $resultScore = mysqli_query($con, "SELECT score FROM member
                              WHERE member.id_member = $opponentMemberID");
        ?>
