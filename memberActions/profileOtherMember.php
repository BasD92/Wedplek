...
if (isset($_POST['clickUsername'])) {
    $_SESSION['placebetMemberID'] = $_POST['placebetMemberID'];
}

$placebetMemberID = $_SESSION['placebetMemberID'];
    ...
    <section>
        ...
        <?php if (isset($_SESSION['username'])) {
            ...
            <ul class="small-image-list">
                ...
                <?php
                $result = mysqli_query($con, "SELECT * FROM member WHERE id_member = $placebetMemberID");
                ?>
...
?>
    ...
    <?php if (isset($_SESSION['username'])) {
        ...
        $resultScore = mysqli_query($con, "SELECT score FROM member
                              WHERE member.id_member = $placebetMemberID");
        ?>
